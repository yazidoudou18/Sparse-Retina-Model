...
local scratchPath               = "/home/twatkins/Workspace/Retina";
local runName                   = "Retina_CIFAR10"; --"Retina_square";
local imageInputPath            = scratchPath .."/" .. "input" .. "/" .. "mixed_cifar.txt";
...
local gap_junction_strength      = 1.0;
